...
namespace Monetria.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260624231921_AddCurrencyCodeToTransactions")]
    partial class AddCurrencyCodeToTransactions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Monetria.Domain.Entities.Recurring", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Monetria.Domain.Entities.RecurringOccurrence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Monetria.Domain.Entities.SavingsPocket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Monetria.Domain.Entities.Budget", b =>
                {
                    b.HasOne("Monetria.Domain.Entities.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Monetria.Domain.Entities.RecurringOccurrence", b =>
                {
                    b.HasOne("Monetria.Domain.Entities.Recurring", "Recurring")
